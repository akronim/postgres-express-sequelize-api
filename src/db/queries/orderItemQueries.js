const seedOrdersItemsTableQuery = `
...
const dropOrdersItemsTableQuery = 'DROP TABLE IF EXISTS orders_items;';

module.exports = { seedOrdersItemsTableQuery, dropOrdersItemsTableQuery };
